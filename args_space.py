...
def get_args():
    ...
    parser.add_argument('--window_U', type=int, default=128, help='the number of readings in a time window in UCI HAR, this dataset is already partitioned into 2.56 s windows')
    ...
    parser.add_argument('--N_users_U', type=int, default=None, help='use its own train test setting in UCI HAR')
    ...
    parser.add_argument('--lr_C', type=float, default=1e-3, help='learning rate for Adam')
    parser.add_argument('--seed', type=int, default=0, help='random seed')
    parser.add_argument('--N_epochs', type=int, default=200, help='the number of epochs for source trained and target trained bounds')
    parser.add_argument('--N_epochs_GAN', type=int, default=100, help='the number of epochs for source trained and target trained bounds')
    parser.add_argument('--N_epochs_ALL', type=int, default=200, help='the number of epochs for source trained and target trained bounds')
    parser.add_argument('--N_epochs_C', type=int, default=100) 
    ...
    parser.add_argument('--N_repeat', type=int, default=1, help='number of repetitions of each experiment')
    parser.add_argument('--n_repeat', type=int, default=1, help='current repetition index of this experiment')
    parser.add_argument('--to_log', type=bool, default=False, help='whether to log the experiment')
